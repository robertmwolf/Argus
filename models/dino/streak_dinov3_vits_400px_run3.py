...
#   2. out_channels=384, neck.in_channels=[384,384,384,384]
#   3. weights='weights/dinov3_vits16_lvd1689m.pth'
#
# Everything else (DINO head, neck out_channels, LR schedule, data pipeline,
# randomness seed) is unchanged so results are directly comparable.
#
# Full training run:
#
