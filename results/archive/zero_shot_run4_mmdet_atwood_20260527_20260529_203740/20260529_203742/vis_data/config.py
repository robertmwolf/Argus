...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='annotations/_zs_eval_run4_mmdet_atwood_20260527.json',
        backend_args=None,
...
test_evaluator = dict(
    ann_file='data/annotations/_zs_eval_run4_mmdet_atwood_20260527.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    outfile_prefix=
    '/Users/robert/Argus/results/zero_shot_run4_mmdet_atwood_20260527_20260529_203740/best_coco_bbox_mAP_epoch_15__zs_eval_run4_mmdet_atwood_20260527',
    type='CocoMetric')
...
work_dir = '/Users/robert/Argus/results/zero_shot_run4_mmdet_atwood_20260527_20260529_203740'
