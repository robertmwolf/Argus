...
load_from = '/Users/robert/Argus-worktrees/darkmatters-data-training/weights/run_gt_dm_satstreaks_dinov3_vitb/best_coco_bbox_mAP_epoch_4.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    metric='bbox',
    outfile_prefix=
    'results/gt_dm_satstreaks_test_eval/best_coco_bbox_mAP_epoch_4_test',
    type='CocoMetric')
...
work_dir = 'results/gt_dm_satstreaks_test_eval'
