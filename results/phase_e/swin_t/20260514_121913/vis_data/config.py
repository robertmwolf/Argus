...
load_from = 'weights/retrain_satstreaks_gtimages_20260507_1050/best_coco_bbox_mAP_epoch_4.pth'
log_level = 'INFO'
...
model = dict(
    ...
    backbone=dict(
        ...
        embed_dims=96,
        init_cfg=dict(
            checkpoint='weights/co_dino_swin_t_coco.pth', type='Pretrained'),
        mlp_ratio=4,
        num_heads=[
            3,
            6,
...
test_evaluator = dict(
    ...
    format_only=False,
    metric='bbox',
    outfile_prefix='results/phase_e/swin_t/best_coco_bbox_mAP_epoch_4_test',
    type='CocoMetric')
...
work_dir = 'results/phase_e/swin_t'
